...
//						"<tr><td><b>Employee ID</b></td><td>"+tableData[data].empId+"</td></tr>" +
//						"<tr><td><b>Description</b></td><td>"+tableData[data].eventType+"</td></tr>"+
//						"<tr><input type='hidden' name='status' value='"+tableData[data].justification+"'></tr>"+
//						"<tr><input type='hidden' name='caseId' value='"+tableData[data].appNum+"'></tr>"+
//						"</tbody></table>"+
////						"</form>"+
//						"</div></td>"
//			document.getElementById("caseDataTable").appendChild(detailTableRow);
			...
			console.log('Transaction failed.  Returned status of ' + xhr.status);
		}
	};
	xhr.send();	
}